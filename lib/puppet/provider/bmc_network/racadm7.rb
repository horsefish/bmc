  ...
  def self.prefetch(resources)
    resources.each_value do |type|
      ...
      type.provider = new(
        ...
        ipv4_dns_from_dhcp: Bmc.munge_boolean(Racadm.s_to_bool(idrac_ipv4['DNSFromDHCP'])),
        ...
        auto_detect: Bmc.munge_boolean(Racadm.s_to_bool(idrac_nic['AutoDetect'])),
        autoneg: Bmc.munge_boolean(Racadm.s_to_bool(idrac_nic['Autoneg'])),
        dedicated_nic_scan_time: idrac_nic['DedicatedNICScanTime'],
        dns_domain_from_dhcp: Bmc.munge_boolean(Racadm.s_to_bool(idrac_nic['DNSDomainFromDHCP'])),
        dns_domain_name: idrac_nic['DNSDomainName'],
        dns_domain_name_from_dhcp: Bmc.munge_boolean(Racadm.s_to_bool(idrac_nic['DNSDomainNameFromDHCP'])),
        dns_bmc_name: idrac_nic['DNSRacName'],
        dns_register: idrac_nic['DNSRegister'],
        duplex: idrac_nic['Duplex'],
        enable: Bmc.munge_boolean(Racadm.s_to_bool(idrac_nic['Enable'])),
        ...
        vlan_enable: Bmc.munge_boolean(Racadm.s_to_bool(idrac_nic['VLanEnable'])),
