...
describe Ipmi::Ipmitool do
  ...
  describe "DELL ipmitool lan print" do
  ...
  describe "IBM ipmitool lan print" do
  ...
  describe "HP ipmitool lan print" do
  ...
  describe "Dell ipmitool user list channel 1" do
      ...
      expect(subject).to include(
                             {
                                 ...
                                 "link_auth" => "true",
                                 "ipmi_msg" => "true",
                                 "channel_priv_limit" => "ADMINISTRATOR"
                             })
      expect(subject).to include(
                             {
                                 "id" => "3",
  ...
  describe "Dell ipmitool user list channel 3" do
